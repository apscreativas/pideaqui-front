    ...
    >
        ...
        <div class="relative z-10 w-full max-w-md md:max-w-2xl rounded-t-3xl md:rounded-2xl max-h-[92dvh] md:max-h-[85vh] overflow-y-auto md:shadow-xl" :style="{ backgroundColor: 'var(--color-card-bg)' }">
            ...
            <div class="relative bg-gray-100 md:w-80 md:shrink-0 md:rounded-l-2xl md:overflow-hidden">
                ...
                <div v-else-if="restaurantStore.restaurant?.default_product_image_url" class="w-full flex items-center justify-center bg-gray-100 overflow-hidden md:h-full md:min-h-[380px]">
                    <img
            ...
            <div class="px-5 pt-5 pb-4">
                ...
                <div class="flex items-center gap-2 mb-5">
                    ...
                    <span v-if="product.is_promotion" class="inline-block text-xs text-white px-2.5 py-0.5 rounded-full font-medium" :style="{ backgroundColor: 'var(--color-secondary)' }">
                        Promo
                    </span>
                </div>
                    ...
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <div class="flex gap-1">
                            ...
                            <span
                                ...
                                :class="isMaxReached(group) ? 'bg-orange-100 text-orange-700' : 'bg-gray-100 text-gray-500'"
                    ...
                    <div class="space-y-2">
                        <button
                            ...
                            :class="isSelected(group, option.id)
                                ? ''
                                : ''"
                            :style="isSelected(group, option.id) ? { borderColor: 'var(--color-secondary)', backgroundColor: 'var(--color-secondary-light)' } : { borderColor: 'var(--color-border-light)', backgroundColor: 'var(--color-card-bg)' }"
                        >
                            <div class="flex items-center gap-3">
                                <div
                                    ...
                                    :class="[
                                        ...
                                        isSelected(group, option.id) ? '' : 'border-gray-300',
                                    ]"
                                    :style="isSelected(group, option.id) ? { borderColor: 'var(--color-secondary)', backgroundColor: 'var(--color-secondary)' } : {}"
                                >
                ...
                <div class="mb-5">
                    ...
                    <textarea
                        ...
                        :style="{ backgroundColor: 'var(--color-input-bg)', borderColor: 'var(--color-border-light)', color: 'var(--color-text)' }"
                        style="--tw-ring-color: var(--color-secondary-ring)"
                    ></textarea>
                </div>
                ...
                <div class="flex items-center gap-4">
                    <div class="flex items-center gap-3 bg-gray-100 rounded-2xl px-3 py-2">
                        <button
                            ...
                            class="w-7 h-7 flex items-center justify-center rounded-full bg-white shadow-sm"
                    ...
                    <button
                        @click="addToCart"
                        :disabled="!isValid"
                        class="flex-1 text-white rounded-2xl py-3 font-semibold text-sm flex items-center justify-between px-5 disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98] transition-transform"
